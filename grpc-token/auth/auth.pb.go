...
func (x *ClaimsResponse) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *ClaimsResponse) GetExpiresAt() int64 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
func (x *ClaimsResponse) GetIssuer() string {
	if x != nil {
		return x.Issuer
	}
	return ""
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x2d, 0x0a, 0x0f, 0x50, 0x61, 0x73, 0x73, 0x77,
	...
	0x6b, 0x65, 0x6e, 0x22, 0x63, 0x0a, 0x0e, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x52, 0x65, 0x73,
	...
	0x52, 0x06, 0x69, 0x73, 0x73, 0x75, 0x65, 0x72, 0x32, 0x82, 0x01, 0x0a, 0x0c, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x38, 0x0a, 0x08, 0x47, 0x65, 0x6e,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x15, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x50, 0x61, 0x73,
	...
	0x65, 0x22, 0x00, 0x12, 0x38, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x73, 0x65, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x12, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x43, 0x6c, 0x61,
	0x69, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x11, 0x5a,
	0x0f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2f, 0x61, 0x75, 0x74, 0x68,
...
var file_auth_auth_proto_goTypes = []interface{}{
	(*PasswordRequest)(nil), // 0: auth.PasswordRequest
	(*TokenRequest)(nil),    // 1: auth.TokenRequest
	(*TokenResponse)(nil),   // 2: auth.TokenResponse
	(*ClaimsResponse)(nil),  // 3: auth.ClaimsResponse
}
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: auth.TokenService.GenToken:input_type -> auth.PasswordRequest
	1, // 1: auth.TokenService.ParseToken:input_type -> auth.TokenRequest
	2, // 2: auth.TokenService.GenToken:output_type -> auth.TokenResponse
	3, // 3: auth.TokenService.ParseToken:output_type -> auth.ClaimsResponse
